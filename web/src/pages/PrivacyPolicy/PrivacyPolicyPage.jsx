  ...
  return (
    <div className={styles.wrapper}>
      <div className={styles.titleWrapper}>
        <div>
          <h1 className={styles.title}>Privacy Policy of Kawaii Krafts</h1>

          <p>
            Kawaii Kraft operates the https://www.kawaiikraft.dev website, which
          ...
          <p>
            ...
            anyone decided to use our Service, the Kawaii Kraft website.
          </p>
          ...
          <p>
            ...
            https://www.kawaiikraft.dev, unless otherwise defined in this
            Privacy Policy.
          </p>

          <h2 className={styles.subtitle}>Information Collection and Use</h2>
          ...
          <h2 className={styles.subtitle}>Log Data</h2>
          ...
          <h2 className={styles.subtitle}>Service Providers</h2>
          ...
          <h2 className={styles.subtitle}>Links to Other Sites</h2>
